...
//   $sql="INSERT INTO vishal(firstname,lastname,email,password,phone_no,address,city,state,zip) VALUES
//    ('$firstname','$lastname','$email','$password','$phone_no','$address','$city','$state',' $zip')";
...
<html lang="en">
  <head>
    ...
    <title>Welcome - <?php $_SESSION['password'] ?></title>
  </head>
  <body>
...
<!-- 
    <div class="container my-4">
      <form class="row g-3" action="/CURD/pro/wlcm.php" method="post">
          <div class="col-md-6">
